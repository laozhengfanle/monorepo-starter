...
| 文档                                                  | 内容                                      |
| ----------------------------------------------------- | ----------------------------------------- |
| [开发文档/项目总览.md](../开发文档/项目总览.md)       | 项目背景与目标                            |
| [开发文档/技术架构.md](../开发文档/技术架构.md)       | 技术选型与架构设计                        |
| [开发文档/目录结构.md](../开发文档/目录结构.md)       | 目录结构详解（含生成物说明）              |
| [开发文档/API设计规范.md](../开发文档/API设计规范.md) | API 设计规范（GraphQL/REST/契约）         |
| [ARCHITECTURE.md](../ARCHITECTURE.md)                 | 认证 / 限流 / 审计三大链路 Mermaid 流程图 |
| [erd.md](../erd.md)                                   | 数据库 ER 图（`pnpm erd:generate` 生成）  |
| [命名规范.md](../命名规范.md)                         | 数据库 / 后端 / 前端命名与工程规范        |
