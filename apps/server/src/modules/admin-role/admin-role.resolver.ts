...
export class AdminRoleResolver {
  ...
  async createRole(
    @Args(
      'input',
      { type: () => CreateRoleInputType },
      new ZodArgsPipe(CreateRoleSchema),
    )
    input: CreateRoleInputType,
    @CurrentAccount() account: AuthAccount,
  ): Promise<AdminRoleType> {
    return this.adminRoleService.create(input as never, account.accountId);
  }
  ...
  async updateRole(
    ...
    @Args(
      'input',
      { type: () => UpdateRoleInputType },
      new ZodArgsPipe(UpdateRoleSchema),
    )
    input: UpdateRoleInputType,
    @CurrentAccount() account: AuthAccount,
  ): Promise<AdminRoleType> {
    return this.adminRoleService.update(id, input as never, account.accountId);
  }
  ...
  async deleteRole(
    ...
    return this.adminRoleService.remove(id, account.accountId);
  }
}
